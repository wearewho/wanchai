...
@section('content')
    {!! Form::open(['method' => 'POST', 'route' => ['admin.managehome.store_review'], 'files' => true]) !!}
    
    <div class="box box-danger">
        <div class="box-header with-border">
            <h3 class="box-title"><b>@lang('global.app_create') @lang('global.website-management.fields.home_review')</b></h3>
            <div class="box-tools">
